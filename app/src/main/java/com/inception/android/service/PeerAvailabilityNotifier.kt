...
/**
 * Owns the user-visible "peers nearby" notification independently of the UI delegate.
...
internal class PeerAvailabilityNotifier(
    ...
    companion object {
        internal const val CHANNEL_ID = "inception_peer_availability_notifications"
