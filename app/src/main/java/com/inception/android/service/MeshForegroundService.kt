...
import com.inception.android.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "inception_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.inception.android.service.START"
        const val ACTION_STOP = "com.inception.android.service.STOP"
        const val ACTION_QUIT = "com.inception.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.inception.android.service.UPDATE_NOTIFICATION"
    ...
    private val unifiedMeshService: com.inception.android.mesh.MeshService?
    ...
    override fun onCreate() {
        ...
        updateJob = scope.launch {
            com.inception.android.services.AppStateStore.peers
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (intent?.action) {
            ACTION_STOP -> {
                ...
                updateJob?.cancel()
                updateJob = null
                try { com.inception.android.services.MessageRouter.tryGetInstance()?.stopOutboxScheduler() } catch (_: Exception) { }
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_inception),
                quitPendingIntent
            )
            .build()
    }
