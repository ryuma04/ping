...
import com.inception.android.noise.NoiseDecryptionResult
...
class SecurityManager(private val encryptionService: EncryptionService, private val myPeerID: String) {
    ...
    companion object {
        ...
        private const val MESSAGE_TIMEOUT = com.inception.android.util.AppConstants.Security.MESSAGE_TIMEOUT_MS // 5 minutes (same as iOS)
        private const val CLEANUP_INTERVAL = com.inception.android.util.AppConstants.Security.CLEANUP_INTERVAL_MS // 5 minutes
        private const val MAX_PROCESSED_MESSAGES = com.inception.android.util.AppConstants.Security.MAX_PROCESSED_MESSAGES
        private const val MAX_PROCESSED_KEY_EXCHANGES = com.inception.android.util.AppConstants.Security.MAX_PROCESSED_KEY_EXCHANGES
        private const val KEY_EXCHANGE_DEDUP_TIMEOUT = com.inception.android.util.AppConstants.Security.KEY_EXCHANGE_DEDUP_TIMEOUT_MS
    }
     ...
     */
    fun validatePacket(packet: InceptionPacket, peerID: String): Boolean {
        ...
        if (processedMessages.contains(messageID)) {
            ...
            val isFreshAnnounce = messageType == MessageType.ANNOUNCE &&
                    packet.ttl >= com.inception.android.util.AppConstants.MESSAGE_TTL_HOPS
    ...
    suspend fun handleNoiseHandshake(routed: RoutedPacket): Boolean {
        ...
        try {
            ...
            if (result.establishedNow) {
                ...
                val isDirectIngress = packet.ttl == com.inception.android.util.AppConstants.MESSAGE_TTL_HOPS
     ...
     */
    private fun generateMessageID(packet: InceptionPacket, peerID: String): String {
     ...
     */
    private fun verifyPacketSignature(packet: InceptionPacket, peerID: String): Boolean {
        try {
