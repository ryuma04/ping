 ...
 * 
 * This class handles all relay decisions and logic for inception packets.
...
class PacketRelayManager(private val myPeerID: String) {
     ...
     */
    internal fun isPacketAddressedToMe(packet: InceptionPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: InceptionPacket, fromPeerID: String): Boolean {
