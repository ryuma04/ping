...
import com.inception.android.favorites.FavoriteControlMessage
...
import com.inception.android.sync.PacketIdUtil
import com.inception.android.util.toHexString
import com.inception.android.features.voice.LiveVoiceManager
import com.inception.android.features.voice.LiveVoiceScope
...
class MessageHandler(private val myPeerID: String, private val appContext: android.content.Context) {
    ...
    suspend fun handleNoiseEncrypted(routed: RoutedPacket): Boolean {
        ...
        try {
            ...
            val noisePayload = com.inception.android.model.NoisePayload.decode(decryptedData)
            ...
            when (noisePayload.type) {
                com.inception.android.model.NoisePayloadType.PRIVATE_MESSAGE -> {
                    // Decode TLV private message exactly like iOS
                    val privateMessage = com.inception.android.model.PrivateMessagePacket.decode(noisePayload.data)
                    if (privateMessage != null) {
                        ...
                        // Create InceptionMessage - preserve source packet timestamp
                ...
                com.inception.android.model.NoisePayloadType.FILE_TRANSFER -> {
                    // Handle encrypted file transfer; generate unique message ID
                    val file = com.inception.android.model.InceptionFilePacket.decode(noisePayload.data)
                    if (file != null) {
                ...
                com.inception.android.model.NoisePayloadType.VOICE_FRAME -> {
                ...
                com.inception.android.model.NoisePayloadType.PEER_STATE -> {
                ...
                com.inception.android.model.NoisePayloadType.DELIVERED -> {
                ...
                com.inception.android.model.NoisePayloadType.READ_RECEIPT -> {
                ...
                com.inception.android.model.NoisePayloadType.VERIFY_CHALLENGE -> {
                    delegate?.onVerifyChallengeReceived(peerID, noisePayload.data, packet.timestamp.toLong())
                }
                com.inception.android.model.NoisePayloadType.VERIFY_RESPONSE -> {
    ...
    private suspend fun sendDeliveryAck(messageID: String, senderPeerID: String) {
        try {
            ...
            val ackPayload = com.inception.android.model.NoisePayload(
                type = com.inception.android.model.NoisePayloadType.DELIVERED,
    ...
    suspend fun handleAnnounceWithResult(routed: RoutedPacket): AnnounceHandlingResult {
        ...
        try {
            val neighborsOrNull = com.inception.android.services.meshgraph.GossipTLV.decodeNeighborsFromAnnouncementPayload(packet.payload)
        ...
        try {
            ...
            if (response != null) {
                ...
                val responsePacket = InceptionPacket(
                    ...
                    payload = response,
                    signature = null,
                    ttl = com.inception.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS
                )
    ...
    private suspend fun handleBroadcastMessage(routed: RoutedPacket) {
        ...
        try {
            ...
            val file = com.inception.android.model.InceptionFilePacket.decode(packet.payload)
            if (file != null) {
     ...
     */
    private suspend fun handlePrivateMessage(packet: InceptionPacket, peerID: String) {
        try {
            val isFileTransfer = com.inception.android.protocol.MessageType.fromValue(packet.type) ==
                com.inception.android.protocol.MessageType.FILE_TRANSFER
    ...
    private fun handleFavoriteNotificationFromMesh(content: String, fromPeerID: String) {
        try {
            ...
            if (noiseKey != null) {
                com.inception.android.favorites.FavoritesPersistenceService.shared.updatePeerFavoritedUs(noiseKey, control.isFavorite)
                if (control.npub != null) {
                    com.inception.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKey(noiseKey, control.npub)
                    com.inception.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(fromPeerID, control.npub)
                }

                val rel = com.inception.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey)
                ...
                val sys = com.inception.android.model.InceptionMessage(
                    sender = "system",
                    content = notice,
                ...
                try {
                    val conversationID = com.inception.android.services.ContactDirectory
                        .canonicalConversationId(fromPeerID)
                    val sysPrivate = com.inception.android.model.InceptionMessage(
                        sender = "system",
                        content = notice,
                        timestamp = java.util.Date(),
                        isRelay = false,
...
interface MessageHandlerDelegate {
    ...
    fun updatePeerInfoFromVerifiedAnnouncement(
        ...
        isVerified: Boolean,
        capabilities: com.inception.android.model.PeerCapabilities? = null
    ): Boolean
    
    // Packet operations
    fun sendPacket(packet: InceptionPacket)
    fun relayPacket(routed: RoutedPacket)
    fun getBroadcastRecipient(): ByteArray
    
    // Cryptographic operations
    fun verifySignature(packet: InceptionPacket, peerID: String): Boolean
    ...
    // Callbacks
    fun onMessageReceived(message: InceptionMessage)
