...
import com.inception.android.crypto.EncryptionService
import com.inception.android.model.InceptionMessage
import com.inception.android.model.AuthenticatedPeerState
import com.inception.android.model.PeerCapabilities
import com.inception.android.protocol.MessagePadding
import com.inception.android.model.RoutedPacket
import com.inception.android.model.IdentityAnnouncement
...
import com.inception.android.protocol.SpecialRecipients
import com.inception.android.model.RequestSyncPacket
import com.inception.android.sync.GossipSyncManager
import com.inception.android.util.toHexString
import com.inception.android.services.VerificationService
import com.inception.android.service.TransportBridgeService
...
class BluetoothMeshService(private val context: Context) : TransportBridgeService.TransportLayer {
    private val debugManager by lazy { try { com.inception.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    
    companion object {
        private const val TAG = "BluetoothMeshService"
        private val MAX_TTL: UByte = com.inception.android.util.AppConstants.MESSAGE_TTL_HOPS
        private const val PEER_DISCONNECT_GRACE_MS = com.inception.android.util.AppConstants.Mesh.PEER_DISCONNECT_GRACE_MS
    }
    ...
    private val privateMediaPreparer by lazy {
        PrivateMediaTransferPreparer(
            ...
            encrypt = { plaintext, peerID, authenticatedSession ->
                ...
                } catch (_: com.inception.android.noise.NoiseSessionError.SessionGenerationChanged) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: com.inception.android.noise.NoiseSessionError.SessionNotFound) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: com.inception.android.noise.NoiseSessionError.SessionNotEstablished) {
                    PrivateMediaEncryptionResult.GenerationChanged
                } catch (_: Exception) {
    ...
    private val serviceNotificationManager = com.inception.android.ui.NotificationManager(
    ...
    init {
        ...
        encryptionService.onSessionEstablished = { peerID ->
            ...
            try {
                com.inception.android.services.MessageRouter
                    .tryGetInstance()
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.inception.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.inception.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.inception.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
                } catch (_: Exception) { 0.01 }
            }
        )

        com.inception.android.service.MeshServiceHolder.setGossipManager(gossipSyncManager) { packet ->
    ...
    override fun sendToPeer(peerID: String, packet: InceptionPacket) {
        if (!isBleTransportEnabled()) return
    ...
    private fun isBleTransportEnabled(): Boolean {
        return try {
            com.inception.android.ui.debug.DebugSettingsManager.getInstance().bleEnabled.value
        } catch (_: Exception) {
            try { com.inception.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        }
    }
    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            override fun onPeerListUpdated(peerIDs: List<String>) {
                ...
                try { com.inception.android.services.AppStateStore.setTransportPeers("BLE", peerIDs) } catch (_: Exception) { }
            ...
            override fun onPeerRemoved(peerID: String) {
                ...
                try { com.inception.android.services.meshgraph.MeshGraphService.getInstance().removePeer(peerID) } catch (_: Exception) { }
        ...
        securityManager.delegate = object : SecurityManagerDelegate {
            ...
            override fun sendHandshakeResponse(peerID: String, response: ByteArray) {
                ...
                val responsePacket = InceptionPacket(
                    version = 1u,
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerInfoFromVerifiedAnnouncement(peerID: String, nickname: String, noisePublicKey: ByteArray, signingPublicKey: ByteArray, isVerified: Boolean, capabilities: com.inception.android.model.PeerCapabilities?): Boolean {
            ...
            override fun verifySignature(packet: InceptionPacket, peerID: String): Boolean {
            ...
            override fun decryptFromPeer(
                ...
                senderPeerID: String
            ): com.inception.android.noise.NoiseDecryptionResult? {
            ...
            override fun onAuthenticatedPeerStateReceived(
                ...
                authenticatedSession: com.inception.android.noise.AuthenticatedNoiseSession
            ) {
            ...
            // Callbacks
            override fun onMessageReceived(message: InceptionMessage) {
                ...
                if (
                    !com.inception.android.services.IncomingMessageAdmission
                ...
                if (delegate == null && message.isPrivate && message.sender != "system") {
                    try {
                        ...
                        if (senderPeerID != null) {
                            ...
                            val preview = com.inception.android.ui.NotificationTextUtils.buildPrivateMessagePreview(message)
            ...
            override fun onDeliveryAckReceived(messageID: String, peerID: String) {
                ...
                try {
                    com.inception.android.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        com.inception.android.model.DeliveryStatus.Delivered(peerID, Date())
                    )
                } catch (_: Exception) { }
            ...
            override fun onReadReceiptReceived(messageID: String, peerID: String) {
                try {
                    com.inception.android.services.AppStateStore.updatePrivateMessageStatus(
                        messageID,
                        com.inception.android.model.DeliveryStatus.Read(peerID, Date())
                    )
                } catch (_: Exception) { }
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: InceptionPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: InceptionPacket): InceptionPacket? {
        ...
        override fun onPacketReceived(
            ...
            try {
                com.inception.android.ui.debug.DebugSettingsManager.getInstance().logIncoming(
                    packet = packet,
                    fromPeerID = peerID,
                    fromNickname = null,
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.inception.android.ui.debug.DebugSettingsManager.getInstance()
    ...
    fun startServices() {
        ...
        if (!isBleTransportEnabled()) {
            ...
            com.inception.android.service.MeshServiceHolder.stopSharedGossip("BLE")
            try { com.inception.android.services.AppStateStore.clearTransportPeers("BLE") } catch (_: Exception) { }
            try { com.inception.android.services.AppStateStore.clearTransportDirectPeers("BLE") } catch (_: Exception) { }
            return
        }
        if (terminated) {
        ...
        if (connectionManager.startServices()) {
            ...
            com.inception.android.service.MeshServiceHolder.startSharedGossip("BLE")
        } else {
    ...
    fun sendFileBroadcast(file: com.inception.android.model.InceptionFilePacket) {
        try {
    ...
    fun sendFilePrivate(recipientPeerID: String, file: com.inception.android.model.InceptionFilePacket) {
    ...
    fun prepareFilePrivate(
        ...
        file: com.inception.android.model.InceptionFilePacket,
        transferId: String,
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.inception.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.inception.android.model.NoisePayload(
                        type = com.inception.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.inception.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.inception.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.inception.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }

            try {
                // Create read receipt payload using NoisePayloadType exactly like iOS
                val readReceiptPayload = com.inception.android.model.NoisePayload(
                    type = com.inception.android.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = InceptionPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.inception.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
                ...
                readReceiptRetrySender.enqueue(
                    ...
                    onComplete = { accepted ->
                        if (accepted) {
                            try {
                                com.inception.android.services.SeenMessageStore
    ...
    fun sendBroadcastAnnounce() {
        serviceScope.launch {
            val nickname = try { com.inception.android.services.NicknameProvider.getNickname(context, myPeerID) } catch (_: Exception) { myPeerID }
            ...
            val basePayload = announcement.encode()
            if (basePayload == null) {
                Log.e(TAG, "Failed to encode announcement as TLV")
                return@launch
            }
            var tlvPayload: ByteArray = basePayload
            ...
            try {
                ...
                if (directPeers.isNotEmpty()) {
                    val gossip = com.inception.android.services.meshgraph.GossipTLV.encodeNeighbors(directPeers)
                    tlvPayload = tlvPayload + gossip
                }
                // Always update our own node in the mesh graph with the neighbor list we used
                try {
                    com.inception.android.services.meshgraph.MeshGraphService.getInstance()
                        .updateFromAnnouncement(myPeerID, nickname, directPeers, System.currentTimeMillis().toULong())
                } catch (_: Exception) { }
            } catch (_: Exception) { }
            
            val announcePacket = InceptionPacket(
    ...
    private fun getDirectPeerIDsForGossip(): List<String> {
        return try {
            ...
            try { com.inception.android.services.AppStateStore.setTransportDirectPeers("BLE", direct) } catch (_: Exception) { }
            val union = try {
                com.inception.android.services.AppStateStore.getDirectPeers().ifEmpty { direct }
     ...
     */
    fun getSessionState(peerID: String): com.inception.android.noise.NoiseSession.NoiseSessionState {
     ...
     */
    private fun applyRouteIfAvailable(packet: InceptionPacket): InceptionPacket {
        return try {
            ...
            if (recipient != null && !recipient.contentEquals(SpecialRecipients.BROADCAST)) {
                ...
                val path = com.inception.android.services.meshgraph.RoutePlanner.shortestPath(
                    myPeerID,
                    destination
                )
    ...
    private fun routeAndSignPrivateMediaStrict(packet: InceptionPacket): InceptionPacket? {
    ...
    private fun signPacketBeforeBroadcast(packet: InceptionPacket): InceptionPacket {
        return try {
