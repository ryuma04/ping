package com.inception.android.features.file
...
object FileUtils {
    ...
    /**
     * Classify InceptionMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.inception.android.model.InceptionMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.inception.android.model.InceptionMessageType.Image
            lower.startsWith("audio/") -> com.inception.android.model.InceptionMessageType.Audio
            else -> com.inception.android.model.InceptionMessageType.File
        }
    }
    ...
    fun deleteConversationMedia(
        context: Context,
        deletedMessages: Collection<InceptionMessage>,
        retainedMessages: Collection<InceptionMessage>
    ) {
