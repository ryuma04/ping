package com.inception.android.features.voice
...
class LiveVoiceManager private constructor(private val context: Context) {
    ...
    @Synchronized
    fun absorbFinalizedVoiceNote(message: InceptionMessage): Boolean {
        if (message.type != InceptionMessageType.Audio) return false
    ...
    private fun createAssembly(key: AssemblyKey, nickname: String, timestampMs: Long): Assembly? {
        ...
        val message = InceptionMessage(
            ...
            type = InceptionMessageType.Audio,
