package com.inception.android.crypto
...
import com.inception.android.noise.NoiseEncryptionService
import com.inception.android.noise.NoiseHandshakeProcessingResult
 ...
 * 
 * This is the main interface for all encryption/decryption operations in inception.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "inception_crypto"
        private const val SECURE_PREFS_NAME = "inception_crypto_secure"
    }
