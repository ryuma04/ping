...
import com.inception.android.features.media.ImageUtils
...
fun ImagePickerButton(
    ...
    val takePictureLauncher = rememberLauncherForActivityResult(
        ...
        if (success && !path.isNullOrBlank()) {
            ...
            val outPath = com.inception.android.features.media.ImageUtils.downscalePathAndSaveToAppFiles(context, path)
    ...
    ComposerActionSurface(
        ...
        Icon(
            ...
            contentDescription = stringResource(com.inception.android.R.string.pick_image),
            tint = tint,
