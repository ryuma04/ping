...
import com.inception.android.geohash.GeohashNostrPrivacyPolicy
import com.inception.android.geohash.LiveLocationPrivacyGate
import com.inception.android.nostr.GeohashMessageHandler
import com.inception.android.nostr.GeohashRepository
import com.inception.android.nostr.NostrBackgroundRuntime
import com.inception.android.nostr.NostrIdentityBridge
import com.inception.android.nostr.NostrProtocol
import com.inception.android.nostr.NostrRelayManager
import com.inception.android.nostr.NostrSubscriptionManager
import com.inception.android.nostr.PoWPreferenceManager
import com.inception.android.nostr.GeohashAliasRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.inception.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.inception.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.inception.android.geohash.ChannelID.Mesh)
    ...
    fun panicReset() {
        ...
        try { com.inception.android.nostr.NostrRelayManager.getInstance(getApplication()).clearAllOnPanic() } catch (_: Exception) {}
        try { com.inception.android.nostr.LocationNotesManager.getInstance().stop() } catch (_: Exception) {}
    }

    fun sendGeohashMessage(content: String, channel: com.inception.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.inception.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.inception.android.model.InceptionMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.inception.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.inception.android.geohash.ChannelID.Mesh -> {
            ...
            is com.inception.android.geohash.ChannelID.Location -> {
                if (locationChannelManager?.canUseSelectedLocationChannel(channel.channel) != true) {
                    ...
                    switchLocationChannel(com.inception.android.geohash.ChannelID.Mesh)
                    return
                }
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        val selectedLocation = selected as? com.inception.android.geohash.ChannelID.Location
