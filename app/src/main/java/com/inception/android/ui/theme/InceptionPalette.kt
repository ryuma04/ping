...
/**
 * Inception-specific color tokens that do not have a faithful Material 3 semantic role.
 *
 ...
 * here lets Material components inherit correct defaults without losing Inception's identity.
 */
@Immutable
data class InceptionPalette(
    // MARK: - Form controls
    /**
...
val LightInceptionPalette = InceptionPalette(
...
val LocalInceptionPalette = staticCompositionLocalOf { DarkInceptionPalette }
