...
class PrivateChatManager(
    ...
    private val unreadReceivedMessages = mutableMapOf<String, MutableList<InceptionMessage>>()
    ...
    fun handleIncomingPrivateMessage(message: InceptionMessage) {
    ...
    fun sendReadReceiptsForPeer(
        ...
        val chats = try { state.getPrivateChatsValue() } catch (_: Exception) { emptyMap<String, List<InceptionMessage>>() }
