...
object MessageGrouping {
     ...
     */
    fun shouldGroup(previous: InceptionMessage?, current: InceptionMessage): Boolean {
     ...
     */
    private fun isSameSender(previous: InceptionMessage, current: InceptionMessage): Boolean {
