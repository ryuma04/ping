...
object VerificationService {
    private const val CONTEXT = "inception-verify-v1"
    private const val RESPONSE_CONTEXT = "inception-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "inception" || uri.host != "verify") return null
