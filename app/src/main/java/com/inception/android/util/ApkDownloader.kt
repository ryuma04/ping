...
internal fun downloadPhaseLabel(phase: ApkDownloader.DownloadPhase): Int = when (phase) {
    ApkDownloader.DownloadPhase.AwaitingConnectivity ->
        com.inception.android.R.string.prepare_apk_phase_awaiting_connectivity
    ApkDownloader.DownloadPhase.Retrying ->
        com.inception.android.R.string.prepare_apk_phase_retrying
    ApkDownloader.DownloadPhase.SelectingSource ->
        com.inception.android.R.string.prepare_apk_phase_selecting_source
    ApkDownloader.DownloadPhase.AwaitingNetworkRoute ->
        com.inception.android.R.string.prepare_apk_phase_awaiting_route
    ApkDownloader.DownloadPhase.Transferring ->
        com.inception.android.R.string.prepare_apk_phase_transferring
    ApkDownloader.DownloadPhase.VerifyingSignature ->
        com.inception.android.R.string.prepare_apk_phase_verifying_signature
}
