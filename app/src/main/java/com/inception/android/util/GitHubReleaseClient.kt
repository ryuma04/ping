...
internal class GitHubReleaseClient(
    ...
    companion object {
        ...
        private const val GITHUB_API_URL =
            "https://api.github.com/repos/permissionlesstech/inception-android/releases/latest"
        ...
        private const val USER_AGENT = "Inception-Android"

        private val SOURCE = ApkDownloadSource(
            id = DefaultApkDownloadSources.GITHUB_ID,
            displayName = "GitHub Releases",
            latestApkUrl = "https://github.com/permissionlesstech/inception-android/releases/latest/" +
                "download/inception-android-universal.apk"
        )
