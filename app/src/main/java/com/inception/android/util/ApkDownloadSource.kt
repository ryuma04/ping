...
/**
 * A trusted location that serves the latest signed universal Inception APK.
 *
    ...
    val all = listOf(
        ApkDownloadSource(
            ...
            latestApkUrls = listOf(
                "https://github.com/permissionlesstech/inception-android/releases/latest/" +
...
enum class ApkDownloadFailureReason(@StringRes val messageRes: Int) {
    ...
    NotInception(R.string.prepare_apk_error_not_inception),
