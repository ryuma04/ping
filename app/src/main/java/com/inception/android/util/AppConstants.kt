...
object AppConstants {
    ...
    object Mesh {
        ...
        object Gatt {
            val SERVICE_UUID: UUID = UUID.fromString("7A9E1D2C-3A4B-5C6D-7E8F-9A0B1C2D3E4F")
            val CHARACTERISTIC_UUID: UUID = UUID.fromString("8B0F2E3D-4B5C-6D7E-8F9A-0B1C2D3E4F5A")
    ...
    object Fragmentation {
        ...
        const val MAX_FRAGMENT_TOTAL_BYTES: Int = 2_097_152
    ...
    object UI {
        ...
        const val ACTION_FORCE_FINISH: String = "com.inception.android.ACTION_FORCE_FINISH"
        const val PERMISSION_FORCE_FINISH: String = "com.inception.android.permission.FORCE_FINISH"
    }
