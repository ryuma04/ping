...
import com.inception.android.mesh.PeerFingerprintManager
import com.inception.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.inception.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.inception.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.inception.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign an InceptionPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.inception.android.protocol.InceptionPacket): com.inception.android.protocol.InceptionPacket? {
    ...
    /**
     * Verify an InceptionPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.inception.android.protocol.InceptionPacket, publicKey: ByteArray): Boolean {
