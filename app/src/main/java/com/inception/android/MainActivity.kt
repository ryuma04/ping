...
import com.inception.android.onboarding.BluetoothCheckScreen
import com.inception.android.onboarding.BluetoothStatus
import com.inception.android.onboarding.BluetoothStatusManager
import com.inception.android.onboarding.BatteryOptimizationManager
import com.inception.android.onboarding.BatteryOptimizationPreferenceManager
import com.inception.android.onboarding.BatteryOptimizationScreen
import com.inception.android.onboarding.BatteryOptimizationStatus
import com.inception.android.onboarding.BackgroundLocationPermissionScreen
import com.inception.android.onboarding.InitializationErrorScreen
import com.inception.android.onboarding.InitializingScreen
import com.inception.android.onboarding.LocationCheckScreen
import com.inception.android.onboarding.LocationStatus
import com.inception.android.onboarding.LocationStatusManager
import com.inception.android.onboarding.OnboardingCoordinator
import com.inception.android.onboarding.OnboardingState
import com.inception.android.onboarding.PermissionExplanationScreen
import com.inception.android.onboarding.PermissionManager
import com.inception.android.ui.ChatScreen
import com.inception.android.ui.ChatViewModel
import com.inception.android.ui.OrientationAwareActivity
import com.inception.android.ui.theme.InceptionTheme
import com.inception.android.wifiaware.WifiAwareController
import com.inception.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.inception.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.inception.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.inception.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.inception.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        meshService = com.inception.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        unifiedMeshService = com.inception.android.service.MeshServiceHolder.getUnifiedOrCreate(applicationContext)
    ...
    private fun checkBluetoothAndProceed() {
        ...
        val bleRequired = try { com.inception.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        if (!bleRequired) {
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.inception.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun handleLocationEnabled() {
        ...
        com.inception.android.wifiaware.WifiAwareController.startIfPossible()
        checkBatteryOptimizationAndProceed()
    }
    ...
    private fun handleOnboardingComplete() {
        ...
        val bleRequired2 = try { com.inception.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        when {
    ...
    private fun startMeshForegroundServiceBestEffort() {
        ...
        try {
            com.inception.android.service.MeshForegroundService.start(applicationContext)
    ...
    private fun initializeApp() {
        lifecycleScope.launch {
            try {
                ...
                com.inception.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.inception.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.inception.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.inception.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.inception.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.inception.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.inception.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.inception.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.inception.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.inception.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.inception.android.geohash.GeohashChannelLevel.REGION
                        else -> com.inception.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.inception.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.inception.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "inception" || uri.host != "verify") return
