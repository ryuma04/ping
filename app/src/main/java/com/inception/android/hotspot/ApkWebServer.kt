package com.inception.android.hotspot
...
class ApkWebServer(
    ...
    private fun serveApk(): Response {
        return try {
            ...
            response.addHeader("Content-Disposition", "attachment; filename=\"inception-${appVersion}.apk\"")
...
<head>
    ...
    <title>Download Inception</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <a href="/inception.apk" class="download-button">
            📥 Download Inception
        </a>
        ...
        <div class="warning">
            ...
            If you already have Inception installed, you may need to uninstall it first before installing this version. Make sure to backup your data if needed.
        </div>
    </div>
</body>
</html>
