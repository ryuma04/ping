...
/**
 * FragmentPayload - 100% interoperable fragment payload structure
 * 
 * Handles the encoding and decoding of packet fragments for BLE MTU limits.
 * 
    ...
    companion object {
        ...
        fun decode(payloadData: ByteArray): FragmentPayload? {
            ...
            try {
                ...
                // Extract total (2 bytes, big-endian)
