...
@Parcelize
enum class InceptionMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * InceptionMessage - 100% compatible with iOS version
 */
@Parcelize
data class InceptionMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: InceptionMessageType = InceptionMessageType.Message,
    val timestamp: Date,
     ...
     *
     * This is local identity metadata, not part of the Inception binary wire format. It lets UI
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): InceptionMessage? {
            try {
