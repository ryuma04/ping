...
class InceptionApplication : Application() {
    ...
    override fun onCreate() {
        ...
        try { com.inception.android.mesh.PowerManager.getInstance(this).start() } catch (t: Throwable) { android.util.Log.e(TAG, "Failed to start PowerManager", t) }
        ...
        try {
            ...
            android.util.Log.e(TAG, "Failed to init Tor", t)
        }

        // Initialize relay directory (loads assets/nostr_relays.csv)
        try { RelayDirectory.initialize(this) } catch (t: Throwable) { android.util.Log.e(TAG, "Failed to init RelayDirectory", t) }

        // Initialize LocationNotesManager dependencies early so sheet subscriptions can start immediately
        try { com.inception.android.nostr.LocationNotesInitializer.initialize(this) } catch (t: Throwable) { }
        ...
        try { ThemePreferenceManager.init(this) } catch (t: Throwable) { }

        // Initialize chat UI mode (matrix transcript vs bubbles)
        try { com.inception.android.ui.theme.ChatUiModeManager.init(this) } catch (t: Throwable) { }

        // Initialize debug preference manager (persists debug toggles)
        try { com.inception.android.ui.debug.DebugPreferenceManager.init(this) } catch (t: Throwable) { }
        ...
        try { com.inception.android.nostr.NostrBackgroundRuntime.initialize(this) } catch (t: Throwable) { }

        // Initialize mesh service preferences
        try { com.inception.android.service.MeshServicePreferences.init(this) } catch (t: Throwable) { }

        // Proactively start the foreground service to keep mesh alive
        try { com.inception.android.service.MeshForegroundService.start(this) } catch (t: Throwable) { }
